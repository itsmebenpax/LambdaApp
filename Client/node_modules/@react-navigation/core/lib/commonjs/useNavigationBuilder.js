...
function useNavigationBuilder(createRouter, options) {
  ...
  const emitter = (0, _useEventEmitter.default)(e => {
    ...
    if (e.target) {
      ...
      if ((_target = target) === null || _target === void 0 ? void 0 : _target.name) {
    ...
    const listeners = [].concat(...routeNames.map(name => {
      ...
      return listeners ? Object.keys(listeners).filter(type => type === e.type).map(type => {
        if (typeof listeners === 'function') {
          var _target2;

          const route = (_target2 = target) !== null && _target2 !== void 0 ? _target2 : state.routes[state.index];
